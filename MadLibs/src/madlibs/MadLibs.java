...
public class MadLibs {
   ...
   // Getters!
    ...
    public void SetAnjective1(String newAdj1) {
        this.adjective1 = newAdj1;
    }
    
    public void SetAnjective2(String newAdj2) {
    ...
    public void putTogetherTheStory() {
        ...
        if (num == 0) {
            ...
            story = "Amanda and her friend "+getName()+" went to the zoo last summer. " + 
  ...
  public static void main(String[] args) {
    ...
    private void setAdjective1(String nextLine) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private void setAdjective2(String nextLine) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
